  ...
  return (
    <div className="DesktopVersion DesktopVersionTwitter">
      ...
      <main className="DesktopVersionMain DesktopVersionMainTwitter ">
        <div className="DesktopVersionMainImg DesktopVersionTwitterImg  ">
          <div>
          ...
          <div className="DesktopVersionFooterTwitter">
            <div className="DesktopVersionFooterContainerTwitter">
